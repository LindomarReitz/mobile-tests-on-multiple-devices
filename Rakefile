def run_tests(emulator, junit_dir)
  system("appiumVersion=\"1.5.2\" deviceName=\"#{emulator}\" deviceOrientation=\"portrait\"  platformVersion=\"4.4\" platformName=\"Android\" browserName='' app=\"sauce-storage: grana.apk\" JUNIT_DIR=\"#{junit_dir}\" bundle exec rspec spec/main_spec.rb")
end
